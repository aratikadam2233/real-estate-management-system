...
public class user_signup extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		  PrintWriter out =resp.getWriter();
		      ...
		      {
		   	   if(username.equals("") || contact.equals("") || email.equals("") || password.equals("") || confirm_password.equals(""))
		   	   {
		   	   ...
		   	   else
		   	   {
		   		   try
		   		   {
		                 String sql= " insert into user_signup (username,contact,email,password,Confirm_password) values ('"+ username +"','"+contact+"','"+ email +"', '"+ password +"','"+ confirm_password +"')";
